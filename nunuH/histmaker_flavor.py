...
processList = {
    'p8_ee_ZnunuHbb_ecm240':    {'fraction':1, 'crossSection': 8.20481e-05, 'inputDir': input_base},  #what are the exact values here?/ correct cross section
}
...
def build_graph(df, dataset):
    ...
    df = df.Define("mcID", "FCCAnalyses::MCParticle::get_pdg(Particle)") # btagging
    results.append(df.Histo1D(("mcID", "", 40, 0, 40), "mcID"))
